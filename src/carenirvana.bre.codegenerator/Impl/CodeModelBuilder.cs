    ...
    public abstract class CodeModelBuilder : ICodeModelBuilder
    {
        ...
        private ICodeMember AddMember(ICodeMember codeMember)
        {
            return new CodeMember(
                codeMember.Name, 
                codeMember.Type, 
                codeMember.Attributes, 
                codeMember.ColumnName, 
                codeMember.InlineIntializeExpression);
        }
        ...
        private ICodeMemberProperty AddMemberProperty(ICodeMemberProperty codeMemberProperty)
        {
            return new CodeMemberProperty(
                    ...
                    codeMemberProperty.ColumnName, 
                    codeMemberProperty.GetStatementBody, 
                    codeMemberProperty.SetStatementBody);
        }
    }
}
